...
<head>
    ...
    <style>
        ...
        .config-box { background: rgba(255, 255, 255, 0.02); border: 1px dashed var(--border-color); border-radius: 8px; padding: 10px; margin: 14px 0 4px 0; }
        .config-title { font-size: 10px; text-transform: uppercase; color: var(--accent-clayton); font-weight: 700; margin-bottom: 6px; letter-spacing: 0.3px; }
        ...
        .control-row label span { color: var(--accent-clayton); font-weight: 800; }
        .control-row input[type="range"] { width: 100%; accent-color: var(--accent-clayton); }
...
<div class="container">
    ...
    <!-- PANEL DE APUESTA COMBINADA EXTENDIDA -->
    <div class="combo-panel">
        ...
        <ul class="combo-list">
            ...
            <li><strong>Eurocopa:</strong> España vs Portugal → Más de 1.5 Goles (93% Acierto)</li>
            <li><strong>LaLiga:</strong> Real Madrid vs Barcelona → Ambos Anotan (90% Acierto)</li>
            <li style="margin-top: 6px; color: var(--accent-green); font-weight: bold;">📊 Puntería Global de la Supercombinada: 71% de Probabilidad Estocástica</li>
        </ul>
    </div>

    <!-- PARTIDO 1: BRASIL VS NORUEGA (MUNDIAL) -->
    <div class="panel">
        ...
        <div class="metrics-vertical-stack">
            ...
            <div class="metric-row-card">
                <span class="metric-label">📈 Prob. de Resultado</span>
                <span class="metric-value" style="color: var(--accent-blue);">21%</span>
            </div>
            <div class="metric-row-card">
                <span class="metric-label">⚽ Goles Esperados (xG)</span>
                <span class="metric-value">2.64 vs 1.85</span>
            </div>
            <div class="metric-row-card">
                <span class="metric-label">🟨 Proyección Tarjetas</span>
                <span class="metric-value" style="color:#f59e0b;">Total: 3 (1L / 2V)</span>
            </div>
            ...
            <div class="metric-row-card">
                <span class="metric-label">🛡️ Coeficiente Caos</span>
                <span class="metric-value" style="color:#ef4444;">0.08</span>
            </div>
            <div class="metric-row-card">
                <span class="metric-label">🧠 Coef. Sináptico</span>
                <span class="metric-value" style="color:#3b82f6;">74.12</span>
            </div>
        </div>

        <div class="config-box">
            <div class="config-title">🎛️ Calibrar Coeficientes</div>
            <div class="control-row">
                <label>Ataque Local: <span>2.44</span></label>
                <input type="range" min="0.5" max="4.0" step="0.01" value="2.44">
            </div>
            <div class="control-row">
                <label>Ataque Visitante: <span>1.95</span></label>
                <input type="range" min="0.5" max="4.0" step="0.01" value="1.95">
            </div>
        </div>
        <button class="btn-clayton">PROCESAR CON CÓPULA DE CLAYTON</button>
    </div>

    <!-- PARTIDO 2: MÉXICO VS INGLATERRA (MUNDIAL) -->
    <div class="panel">
        <div class="tournament-line">
            <span>Mundial 2026 🏆 - Octavos</span>
            <span style="color: var(--accent-clayton); font-weight: bold;">Mañana | 02:00h</span>
        </div>
        <div class="team-vs">México 🇲🇽 vs Inglaterra 🏴󠁧󠁢󠁥󠁮󠁧󠁿</div>
        <div class="venue-info">🏟️ Estadio Azteca, CDMX</div>
        <div class="weather-info">🌤️ Clima: 🌋 24°C - Altitud Extrema (2.240m)</div>
        ...
        <div class="metrics-vertical-stack">
            <div class="metric-row-card">
                <span class="metric-label">🔮 Resultado Exacto</span>
                <span class="metric-value" style="color: var(--accent-clayton);">1 - 2</span>
            </div>
            <div class="metric-row-card">
                <span class="metric-label">📈 Prob. de Resultado</span>
